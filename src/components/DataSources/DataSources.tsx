...
const sources: DataSource[] = [
  ...
  },
  {
    ...
    providerType: 'government',
    description: 'Technical and operational data from Mozambique\'s national mining regulator. Includes inspection records, geological assessments, artisanal mining zone designations and miner association registrations.',
    url: 'https://www.inami.gov.mz',
    dataTypes: ['Inspection dates', 'ASM zone designations (95 areas)', 'Cooperative/association registrations (53 active)', 'Geological assessments', 'Worker registration data'],
    coverage: 'National',
